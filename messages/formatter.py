...
def format_intro_message(participant_names: list[str], ai_enabled: bool) -> str:
    ...
    return (
        ...
        f"💪 10:00 (Пн–Пт) — надсилаю тренування на день\n"
        f"✅ /done — відмічаєте виконання, миттєво\n"
        f"↩️ /undone [ім'я] — скасувати відмітку (свою або будь-кого)\n"
        f"🏆 Коли всі виконали — одразу святкове повідомлення в чат\n"
        f"📈 П'ятниця, 18:00 — підсумок тижня\n\n"
        f"Команди будь-коли:\n"
...
def format_help_message(reminder_time_str: str, reminder_timezone: str) -> str:
    ...
    return (
        ...
        f"/undone [ім'я] — скасувати відмітку (свою або будь-кого з команди)\n"
