...
- Бот пише сам, без команди, тільки у трьох випадках (усі Пн–Пт, вихідні — повна тиша):
  1. Щоденне нагадування о 10:00, автоматичне визначення тижня
  2. Раз на 4 тижні (старт 5, 9, 13-го тижня), о 8:30 в понеділок — просить
     учасників скинути фото прогресу
  3. П'ятничний підсумок тижня о 18:00
- Коли **всі** учасники виконали — миттєве святкове повідомлення в чат
  ...
  не спрацьовує, навіть якщо всі відмітились), одразу після нього — опитування
  "Як сьогоднішнє тренування?" (важко / середньо / легко / можу ще підхід)
