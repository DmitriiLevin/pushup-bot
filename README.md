...
- Щоденне нагадування о 10:00 (Пн–Пт), автоматичне визначення тижня
...
- Коли **всі** учасники виконали — миттєве святкове повідомлення в чат
  (не за розкладом, а точно в момент, коли останній тисне `/done`)
- П'ятничний підсумок тижня о 18:00
